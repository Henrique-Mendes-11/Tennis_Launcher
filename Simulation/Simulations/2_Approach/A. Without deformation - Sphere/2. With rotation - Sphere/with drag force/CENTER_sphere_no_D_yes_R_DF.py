...
#ball = vp.sphere(pos=vp.vector(x0,avg_dist_cp,0), radius=ball_radius_m, color=vp.color.yellow, make_trail=True)
ball = vp.sphere(pos=pos_init, radius=ball_radius_m, texture=vp.textures.earth, make_trail=False) #Earth texture used to clearly see the rotation of the ball
# In "right":
#ball = vp.sphere(pos=vp.vector(-round(court_length/2, 3),avg_dist_cp,singles_court_width/2), radius=0.08, color=vp.color.yellow, make_trail=True)
