# 3D Ellipsoid trajectroy using vpython 
"""FIRST RUN FILE: LagrangianEq_wXYZ_e_MAIN.py to generate the data file"""
...
file_path = os.path.join(current_dir, '3DBallTest_e_MAIN.npy')
